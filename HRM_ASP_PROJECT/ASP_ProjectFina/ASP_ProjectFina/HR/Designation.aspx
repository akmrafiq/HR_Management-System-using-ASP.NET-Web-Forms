<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Designation.aspx.cs" Inherits="ASP_ProjectFina.HR.Designation" %>
        ...
        <div id="entryTable">
            <div id="deptEntry">
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="ddlDept" runat="server" CssClass="form-control" style="width:286px;"></asp:DropDownList>
                </div>
