<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Section.aspx.cs" Inherits="ASP_ProjectFina.HR.Section" %>
    ...
    <div id="entryTable">
        <div id="deptEntry">
            <div class="form-group">
                ...
                <asp:TextBox ID="txtSecCode" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
            <div class="form-group">
